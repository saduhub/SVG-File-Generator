...
// Test if the generate() method has the correct output in every instance of triangle
test('generate() method', () => {
    const triangle = new Triangle('triangle', 'green', 'yellow', 'triangle text');
    const writeToSVG = triangle.generate();
    ...
    // This is comparing the output of triangle.generate() to svgParams defined above.
