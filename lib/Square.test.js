...
test('setColor() method', () => {
    ...
    expect(square.fill).toBe('blue');
});
// Test if the generate() method has the correct output in every instance of square
test('generate() method', () => {
    const square = new Square('square', 'green', 'yellow', 'square text');
    const writeToSVG = square.generate();
    ...
    // This is comparing the output of square.generate() to svgParams defined above.
